...
RESOURCES += src/qt/surge.qrc src/qt/surge_locale.qrc

TRANSLATIONS += src/qt/locale/surge_bg.ts \
                src/qt/locale/surge_de.ts \
                src/qt/locale/surge_en.ts \
                src/qt/locale/surge_es.ts \
                src/qt/locale/surge_fi.ts \
                src/qt/locale/surge_fr.ts \
                src/qt/locale/surge_it.ts \
                src/qt/locale/surge_ja.ts \
                src/qt/locale/surge_pl.ts \
                src/qt/locale/surge_pt.ts \
                src/qt/locale/surge_ru.ts \
                src/qt/locale/surge_sk.ts \
                src/qt/locale/surge_sv.ts \
                src/qt/locale/surge_vi.ts \
                src/qt/locale/surge_zh_CN.ts \
                src/qt/locale/surge_zh_TW.ts
