Contributing to SURGE Core
============================

The SURGE Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/surge-project/surge/blob/master/doc/translation_process.md)
...
The following applies to code changes to the SURGE Core project, and is not to be
confused with overall SURGE Network Protocol consensus changes.

Whether a pull request is merged into SURGE Core rests with the project merge
...
Patches that change SURGE consensus rules are considerably more involved than
...
Where a patchset proposes to change the SURGE consensus, it must have been
...
The project leader is the release manager for each SURGE Core release.
