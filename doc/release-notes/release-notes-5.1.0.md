SURGE Core version v5.1.0 is now available from:  <https://github.com/surge-project/surge/releases>
...
- #2170 Better surge.conf Masternode data error notification (furszy)
