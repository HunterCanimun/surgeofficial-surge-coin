...
To build SURGE Core using AFL instrumentation (this assumes that the
...
with certain assembly code from SURGE Core's code. See [developer notes on sanitizers](https://github.com/Surge/surge-official-coin/blob/master/doc/developer-notes.md#sanitizers)
