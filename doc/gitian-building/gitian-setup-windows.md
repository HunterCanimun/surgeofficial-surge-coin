...
The build script we'll be using is contained in the SURGE github repository ([contrib/gitian-build.py](https://github.com/surge-project/surge/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the SURGE repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/Surge/surge-official-coin/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, surge-detached-sigs, and surge GitHub repos.
