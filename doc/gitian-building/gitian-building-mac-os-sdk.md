...
The script [extract-osx-sdk.sh](https://github.com/surge-project/surge/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
surge/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/surge-project/surge/blob/master/doc/README_osx.md) for troubleshooting tips.