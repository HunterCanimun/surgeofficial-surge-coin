...
EXPECTED_CIRCULAR_DEPENDENCIES=(
    ...
    "qt/surge/addresseswidget -> qt/surge/surgegui -> qt/surge/addresseswidget"
    "qt/surge/navmenuwidget -> qt/surge/surgegui -> qt/surge/navmenuwidget"
    "qt/surge/surgegui -> qt/surge/qtutils -> qt/surge/surgegui"
    "qt/surge/qtutils -> qt/surge/snackbar -> qt/surge/qtutils"
    "sapling/saplingscriptpubkeyman -> wallet/wallet -> sapling/saplingscriptpubkeyman"
    "spork -> sporkdb -> spork"
    "spork -> validation -> spork"
    "txmempool -> validation -> txmempool"
    "validation -> validationinterface -> validation"
    "validation -> zsrg/zsrgmodule -> validation"
    "wallet/fees -> wallet/wallet -> wallet/fees"
    "wallet/scriptpubkeyman -> wallet/wallet -> wallet/scriptpubkeyman"
    "wallet/wallet -> wallet/walletdb -> wallet/wallet"
    "wallet/wallet -> zsrgchain -> wallet/wallet"
    "zsrg/zsrgmodule -> zsrgchain -> zsrg/zsrgmodule"
    ...
    "qt/askpassphrasedialog -> qt/surge/surgegui -> qt/surge/topbar -> qt/askpassphrasedialog"
    "qt/surge/coldstakingwidget -> qt/surge/tooltipmenu -> qt/surge/surgegui -> qt/surge/coldstakingwidget"
    "qt/surge/masternodeswidget -> qt/surge/tooltipmenu -> qt/surge/surgegui -> qt/surge/masternodeswidget"
    "qt/surge/surgegui -> qt/surge/send -> qt/surge/tooltipmenu -> qt/surge/surgegui"
    ...
    "chain -> legacy/stakemodifier -> validation -> zsrgchain -> chain"
