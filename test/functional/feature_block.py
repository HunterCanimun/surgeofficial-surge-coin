...
class FullBlockTest(SurgeTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure surged isn't accepting b26
        ...
        # Extend the b28 chain to make sure surged isn't accepting b28
        ...
        # SURGE: timestamp checks disabled for regtest
        ...
        #    Low-S and High-S values (whereas the surge code has custom code which does so);
