...
class SaplingFillBlockTest(SurgeTestFramework):
    ...
    def utxo_splitter(self, node_from, n_inputs, node_to):
        ...
        # split each one in 100 (use fixed 0.05 SRG fee)
        for u in utxos:
    ...
    def run_test(self):
        ...
        # Split 10 utxos (of 250 SRG each) in 1000 new utxos of ~2.5 SRG each (to alice)
        UTXOS_TO_SPLIT = 10
        ...
        # Now alice shields the new utxos individually (fixed 0.2 SRG fee --> ~2.3 SRG notes)
