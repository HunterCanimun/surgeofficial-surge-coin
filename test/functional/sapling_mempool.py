#!/usr/bin/env python3
# Copyright (c) 2020 The SURGE Core developers
...
class SaplingMempoolTest(SurgeTestFramework):
    ...
    def run_test(self):
        ...
        # miner sends a 10 SRG note to Alice
        ...
        # miner sends another 10 SRG note to Alice
