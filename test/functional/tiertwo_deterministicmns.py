...
class DIP3Test(SurgeTestFramework):
    ...
    def run_test(self):
        ...
        # Note: dmn2 sends (2 * 0.3 SRG) to the operator, and (2 * 2.7 SRG) to the owner
        ...
        assert_raises_rpc_error(-5, "invalid SURGE address InvalidPayee",
        ...
        assert_raises_rpc_error(-5, "invalid SURGE address InvalidPayee", controller.protx_update_registrar,
