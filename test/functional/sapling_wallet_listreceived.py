...
class ListReceivedTest (SurgeTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 SRG.
        ...
        # Send 1 SRG to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 SRG sending them all (fee is 0.1 SRG)
        ...
        # Confirm transaction (2 SRG from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 SRG, send 0.6 SRG + 0.05 SRG fee
