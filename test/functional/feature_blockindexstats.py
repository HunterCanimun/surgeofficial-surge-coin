...
class BlockIndexStatsTest(SurgeTestFramework):
    ...
    def send_tx(self, node_from, node_to, fee, fFromShield, fToShield):
        if not fFromShield and not fToShield:
            ...
            # add 1 SRG "change" output 50% of the times
    ...
    def run_test(self):
        ...
        # miner creates 20 notes of 10 SRG + 9 notes of 5 SRG + 1 note of 4 SRG (using 1.0 fee)
