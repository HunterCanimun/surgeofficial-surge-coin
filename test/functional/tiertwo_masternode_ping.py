...
Does not use functions of SurgeTier2TestFramework as we don't want to send
...
class MasternodePingTest(SurgeTestFramework):
    ...
    def run_test(self):
        ...
        collateralTxId = miner.sendtoaddress(mnAddress, Decimal('85000'))
        miner.generate(2)
        self.sync_blocks()
        time.sleep(1)
        collateral_rawTx = owner.getrawtransaction(collateralTxId, 1)
        assert_equal(owner.getbalance(), Decimal('85000'))
