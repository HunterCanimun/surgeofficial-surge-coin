...
from test_framework.test_framework import SurgeTier2TestFramework
...
class MasternodeGovernanceBasicTest(SurgeTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposalLink = "https://forum.surge.org/t/test-proposal"
