...
class NetTest(SurgeTestFramework):
    ...
    def _test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(ipv6_addr, 6120)

        # Add 85,000 IPv4 addresses to the address manager. Due to the way bucket
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 6120)
