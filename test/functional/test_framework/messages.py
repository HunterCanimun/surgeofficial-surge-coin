...
COIN = 100000000 # 1 SRG in satoshis
...
# Objects that map to surged objects, which can be serialized/deserialized
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in surged indicates these should be deserialized as blocks
