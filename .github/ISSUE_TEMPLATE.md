...
This issue tracker is only for technical issues related to SURGE Core.
General SURGE questions and/or support requests and are best directed to the [SURGE Discord](https://discord.surgeofficial.uk).
...
### What version of SURGE Core are you using?
