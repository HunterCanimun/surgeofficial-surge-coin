...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help")) {
        ...
        std::string strUsage = _("Surge Core surge-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  surge-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded surge transaction") + "\n" +
                               "  surge-tx [options] -create [commands]   " + _("Create hex-encoded surge transaction") + "\n" +
                               "\n";
