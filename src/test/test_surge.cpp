...
#define BOOST_TEST_MODULE Surge Test Suite
...
BasicTestingSetup::BasicTestingSetup(const std::string& chainName)
    : m_path_root(fs::temp_directory_path() / "test_surge" / strprintf("%lu_%i", (unsigned long)GetTime(), (int)(InsecureRandRange(1 << 30))))
{
    ECC_Start();
    BLSInit();
    SetupEnvironment();
