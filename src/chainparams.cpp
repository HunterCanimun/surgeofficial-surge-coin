...
static Checkpoints::MapCheckpoints mapCheckpoints = {
	{ 0, uint256S("00000f46b81cd71dee4aefa7bfa93f0aaa7053c824fd22afa9ca71596d963aa4")},
    { 100, uint256S("00000266b64a0726c7f94415bee5f99434b464b4f1a02d8693631b4c6a324a6b")},
    { 292, uint256S("adc04f7cf58e61d11e071713bfc7f6f0b33a0d36a92d1efdb7c17072ebfa19c3")},  // POS Activation
    { 500, uint256S("f10c0b5cec515c626cd74881e2cbc2fdac30ee7b72e507fca64dd4af6c6950da")}, // BIP Activation
    { 1500, uint256S("22a61b8f36ec6124eb2893e194d5116aac97efb386372072ffe0c7bbba2f5329")}, // POS V3_4 Activation
    { 4000, uint256S("5921aa042cfb4b1677f15d5178bda016d8a29b6736a73894ac0ca898f4846c7e")}, // POS V4_0 Activation
    { 6000, uint256S("b81f66371ed2d6a92ba8b95a166d5a078fbedeb3437a3165c6dead3cb7ba165e")}, // POS V5_0 Activation
	{ 60000, uint256S("e1283e578394f0a8b32ee85b510049b5f2881cde2d7eb3a93e8fcca2147188de")}, 
	{ 198353, uint256S("d206a310dd75e1e47bc5a1828936b34d4995b594a34b4f819d01dc1ea96714f9")}, 
};

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1629409650, // * UNIX timestamp of last checkpoint block
    398428,    // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        consensus.nBudgetCycleBlocks = 1200;       // approx. 1 every 30 days
        ...
        consensus.vUpgrades[Consensus::UPGRADE_V5_2].nActivationHeight          = 218363;
		...
		**/
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x65, 0x8d, 0x7b, 0xa5};
        base58Prefixes[EXT_SECRET_KEY] = {0xc6, 0x0d, 0x0b, 0x9e};
        // BIP44 coin type is from https://github.com/satoshilabs/slips/blob/master/slip-0044.md
        base58Prefixes[EXT_COIN_TYPE] = {0x80, 0x00, 0x03, 0x3a};
...
public:
    CTestNetParams()
    {
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0xb1, 0x8f, 0x28, 0xaa};
        // Testnet surge BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = {0xa3, 0x73, 0x93, 0x53};
...
public:
    CRegTestParams()
    {
        ...
        */
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet surge addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet surge script addresses start with '8' or '9'
