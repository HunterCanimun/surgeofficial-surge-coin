...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(SRG);
    unitlist.append(mSRG);
    unitlist.append(uSRG);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case SRG:
        return QString("surge");
    case mSRG:
        return QString("msurge");
    case uSRG:
        return QString::fromUtf8("usurge");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZsrg)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZSRG)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZSRG);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZSRG)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZSRG));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
