...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            SURGEGUI* window = static_cast<SURGEGUI*>(parentWidget());
...
{
    SURGEGUI* gui = static_cast<SURGEGUI*>(parentWidget());
...
{
    hide();
    static_cast<SURGEGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("SURGE will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your SRGs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
