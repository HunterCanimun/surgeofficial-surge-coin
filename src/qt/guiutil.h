...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZsrg = false);
QString formatBalanceWithoutHtml(CAmount amount, int nDisplayUnit = 0, bool isZsrg = false);
...
// Parse "surge:" URI into recipient object, return true on successful parsing
