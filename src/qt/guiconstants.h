...
/* Surge GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "SURGE"
#define QAPP_ORG_DOMAIN "surge.org"
#define QAPP_APP_NAME_DEFAULT "SURGE-Qt"
#define QAPP_APP_NAME_TESTNET "SURGE-Qt-testnet"
