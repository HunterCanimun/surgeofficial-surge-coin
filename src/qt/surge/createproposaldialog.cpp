...
#include "qt/surge/createproposaldialog.h"
#include "qt/surge/forms/ui_createproposaldialog.h"

#include "qt/surge/contactsdropdown.h"
...
CreateProposalDialog::CreateProposalDialog(SURGEGUI* parent, GovernanceModel* _govModel, WalletModel* _walletModel) :
    QDialog(parent),
...
void CreateProposalDialog::setupPageOne()
{
    ...
    setEditBoxStyle(ui->labelURL, ui->lineEditURL, "e.g https://forum.surge/proposals/best_proposal_ever");
...
void CreateProposalDialog::setupPageTwo()
{
    ...
    setEditBoxStyle(ui->labelAmount, ui->lineEditAmount, "e.g 500 SRG");
