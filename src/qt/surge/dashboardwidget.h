...
#include "config/surge-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalSrg = 0;
    qint64 totalZsrg = 0;
    QList<qreal> valuesSrg;
    QList<qreal> valueszSrg;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(SURGEGUI* _window);
    ~DashboardWidget();
