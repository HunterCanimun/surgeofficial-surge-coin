...
#include "qt/surge/furabstractlistitemdelegate.h"
#include "qt/surge/txviewholder.h"
#include "qt/surge/tooltipmenu.h"
#include "qt/surge/sendmultirow.h"
#include "qt/surge/coldstakingmodel.h"
...
public:
    explicit ColdStakingWidget(SURGEGUI* parent);
    ~ColdStakingWidget();
