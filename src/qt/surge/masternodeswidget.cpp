...
#include "qt/surge/forms/ui_masternodeswidget.h"

#include "qt/surge/qtutils.h"
#include "qt/surge/mnrow.h"
#include "qt/surge/mninfodialog.h"
#include "qt/surge/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(SURGEGUI *parent) :
    PWidget(parent),
    ...
    if (fs::exists(pathBootstrap)) {
        ...
        if (lineCopy.size() == 0) {
            lineCopy = "# Masternode config file\n"
                                    ...
                                    "# Example: mn1 127.0.0.2:6120 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0\n";
        }
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= (COIN * 85000)) {
        inform(tr("Not enough balance to create a masternode, 85,000 %1 required.").arg(CURRENCY_UNIT.c_str()));
        return;
    }
    showHideOp(true);
