...
#include "qt/surge/contactdropdownrow.h"
...
ContactsDropdown::ContactsDropdown(int minWidth, int minHeight, SURGEGUI* _window, QWidget* _parent) : PWidget(_window, _parent)
{
