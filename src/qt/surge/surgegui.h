...
#ifndef SURGE_CORE_NEW_GUI_SURGEGUI_H
#define SURGE_CORE_NEW_GUI_SURGEGUI_H
...
#include "qt/surge/navmenuwidget.h"
#include "qt/surge/topbar.h"
#include "qt/surge/dashboardwidget.h"
#include "qt/surge/send.h"
#include "qt/surge/receivewidget.h"
#include "qt/surge/addresseswidget.h"
#include "qt/surge/coldstakingwidget.h"
#include "qt/surge/governancewidget.h"
#include "qt/surge/masternodeswidget.h"
#include "qt/surge/snackbar.h"
#include "qt/surge/settings/settingswidget.h"
...
/**
  SURGE GUI main class. This class represents the main window of the SURGE UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class SURGEGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit SURGEGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~SURGEGUI();
...
#endif //SURGE_CORE_NEW_GUI_SURGEGUI_H
