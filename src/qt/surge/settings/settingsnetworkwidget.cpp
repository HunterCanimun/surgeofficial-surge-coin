...
#include "qt/surge/settings/settingsnetworkwidget.h"
#include "qt/surge/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/surge/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(SURGEGUI* _window, QWidget *parent) :
