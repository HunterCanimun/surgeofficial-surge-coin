...
#include "qt/surge/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/surge/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(SURGEGUI* _window, QWidget *parent) :
