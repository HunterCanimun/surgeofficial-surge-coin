...
#include "qt/surge/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/surge/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(SURGEGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to SURGEGUI::handleRestart()
