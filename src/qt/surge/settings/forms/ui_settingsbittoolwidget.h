...
public:
    ...
    void retranslateUi(QWidget *SettingsBitToolWidget)
    {
        ...
        labelSubtitle1->setText(QApplication::translate("SettingsBitToolWidget", "Encrypt your SURGE addresses (key pair actually) using BIP38 encryption.\n"
"Using this mechanism you can share your keys without middle-man risk, only need to store your passphrase safely", Q_NULLPTR));
        ...
        labelSubtitleAddress->setText(QApplication::translate("SettingsBitToolWidget", "SURGE address", Q_NULLPTR));
