...
public:
    ...
    QHBoxLayout *horizontalPercentagezSrg;
    QLabel *labelTitleUnit;
    QSpacerItem *horizontalSpacerPercentagezSrg;
    QValueComboBox *comboBoxUnit;
    QHBoxLayout *horizontalDenomzSrg;
    QLabel *labelTitleDigits;
    QSpacerItem *horizontalDenomzSrg_1;
    ...
    void setupUi(QWidget *SettingsDisplayOptionsWidget)
    {
        ...
        horizontalPercentagezSrg = new QHBoxLayout();
        horizontalPercentagezSrg->setObjectName(QStringLiteral("horizontalPercentagezSrg"));
        labelTitleUnit = new QLabel(left);
        labelTitleUnit->setObjectName(QStringLiteral("labelTitleUnit"));

        horizontalPercentagezSrg->addWidget(labelTitleUnit);

        horizontalSpacerPercentagezSrg = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        horizontalPercentagezSrg->addItem(horizontalSpacerPercentagezSrg);
        ...
        horizontalPercentagezSrg->addWidget(comboBoxUnit);


        verticalLayout_2->addLayout(horizontalPercentagezSrg);

        horizontalDenomzSrg = new QHBoxLayout();
        horizontalDenomzSrg->setObjectName(QStringLiteral("horizontalDenomzSrg"));
        labelTitleDigits = new QLabel(left);
        labelTitleDigits->setObjectName(QStringLiteral("labelTitleDigits"));

        horizontalDenomzSrg->addWidget(labelTitleDigits);

        horizontalDenomzSrg_1 = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        horizontalDenomzSrg->addItem(horizontalDenomzSrg_1);
        ...
        horizontalDenomzSrg->addWidget(comboBoxDigits);


        verticalLayout_2->addLayout(horizontalDenomzSrg);
