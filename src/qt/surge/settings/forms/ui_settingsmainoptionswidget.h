...
public:
    ...
    QSpacerItem *verticalPercentagezSrg;
    QLabel *labelDivider;
    ...
    void setupUi(QWidget *SettingsMainOptionsWidget)
    {
        ...
        verticalPercentagezSrg = new QSpacerItem(20, 20, QSizePolicy::Minimum, QSizePolicy::Fixed);

        verticalLayout_2->addItem(verticalPercentagezSrg);
