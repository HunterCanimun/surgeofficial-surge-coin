...
QT_MOC_LITERAL(5, 64, 9), // "showEvent"
QT_MOC_LITERAL(6, 74, 11), // "QShowEvent*"
QT_MOC_LITERAL(7, 86, 5), // "event"
QT_MOC_LITERAL(8, 92, 9), // "hideEvent"
QT_MOC_LITERAL(9, 102, 11), // "QHideEvent*"
QT_MOC_LITERAL(10, 114, 18), // "openNetworkMonitor"
QT_MOC_LITERAL(11, 133, 18), // "setMasternodeCount"
QT_MOC_LITERAL(12, 152, 14) // "strMasternodes"

    },
    "SettingsInformationWidget\0setNumConnections\0"
    "\0count\0setNumBlocks\0showEvent\0QShowEvent*\0"
...
void SettingsInformationWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->openNetworkMonitor(); break;
        case 5: _t->setMasternodeCount((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
