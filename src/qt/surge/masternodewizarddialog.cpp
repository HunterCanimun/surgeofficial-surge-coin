...
#include "qt/surge/forms/ui_masternodewizarddialog.h"
    ...
    clientModel(_clientModel)
{
    ...
    ui->labelMessage1a->setText(formatHtmlContent(
                formatParagraph(tr("To create a SURGE Masternode you must dedicate %1 (the unit of SURGE) "
    ...
    if (walletModel->isRegTestNetwork()) {
        ui->lineEditPort->setText("8320");
    } else if (walletModel->isTestNetwork()) {
        ui->lineEditPort->setText("7120");
    } else {
        ui->lineEditPort->setText("6120");
    }
