...
#ifndef SURGE_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define SURGE_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //SURGE_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
