...
#include "qt/surge/sendcustomfeedialog.h"
#include "qt/surge/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(SURGEGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &SURGEGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
