...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, SURGEGUI* gui, double posX = 3, int posY = 5, bool hideOpaqueBackground = true);
bool openDialogWithOpaqueBackground(QDialog* widget, SURGEGUI* gui, double posX = 3);
