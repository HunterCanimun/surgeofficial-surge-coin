...
public:
    ...
    QLabel *labelSquareSrg;
    QLabel *labelSrg;
    QSpacerItem *horizontalSpacer_5;
    QLabel *labelSquarezSrg;
    QLabel *labelZsrg;
    ...
    void setupUi(QWidget *DashboardWidget)
    {
        ...
        labelAmountSrg = new QLabel(right);
        labelAmountSrg->setObjectName(QStringLiteral("labelAmountSrg"));
        labelAmountSrg->setText(QStringLiteral("0 SRG"));
        labelAmountSrg->setAlignment(Qt::AlignCenter);

        horizontalLayout_5->addWidget(labelAmountSrg);

        labelAmountZsrg = new QLabel(right);
        labelAmountZsrg->setObjectName(QStringLiteral("labelAmountZsrg"));
        labelAmountZsrg->setText(QStringLiteral("0 zSRG"));
        labelAmountZsrg->setAlignment(Qt::AlignCenter);

        horizontalLayout_5->addWidget(labelAmountZsrg);
        ...
        labelSquareSrg = new QLabel(verticalWidgetChart);
        labelSquareSrg->setObjectName(QStringLiteral("labelSquareSrg"));
        labelSquareSrg->setMinimumSize(QSize(14, 14));
        labelSquareSrg->setMaximumSize(QSize(14, 14));

        horizontalLayout_4->addWidget(labelSquareSrg);

        labelSrg = new QLabel(verticalWidgetChart);
        labelSrg->setObjectName(QStringLiteral("labelSrg"));
        labelSrg->setText(QStringLiteral("SRG"));

        horizontalLayout_4->addWidget(labelSrg);

        horizontalSpacer_5 = new QSpacerItem(10, 20, QSizePolicy::Fixed, QSizePolicy::Minimum);

        horizontalLayout_4->addItem(horizontalSpacer_5);

        labelSquarezSrg = new QLabel(verticalWidgetChart);
        labelSquarezSrg->setObjectName(QStringLiteral("labelSquarezSrg"));
        labelSquarezSrg->setMinimumSize(QSize(14, 14));
        labelSquarezSrg->setMaximumSize(QSize(14, 14));

        horizontalLayout_4->addWidget(labelSquarezSrg);

        labelZsrg = new QLabel(verticalWidgetChart);
        labelZsrg->setObjectName(QStringLiteral("labelZsrg"));
        labelZsrg->setText(QStringLiteral("zSRG"));

        horizontalLayout_4->addWidget(labelZsrg);
...
"}"));
    ...
    void retranslateUi(QWidget *DashboardWidget)
    {
        ...
        btnHowTo->setText(QApplication::translate("DashboardWidget", "How to get SRG", Q_NULLPTR));
        labelTitle2->setText(QApplication::translate("DashboardWidget", "Staking Rewards", Q_NULLPTR));
        labelMessage->setText(QApplication::translate("DashboardWidget", "Amount of SRG and zSRG staked.", Q_NULLPTR));
        labelChart->setText(QApplication::translate("DashboardWidget", "Staking statistics", Q_NULLPTR));
        labelSquareSrg->setText(QString());
        labelSquarezSrg->setText(QString());
