...
"}"));
        ...
        labelSubtitle2->setStyleSheet(QStringLiteral(""));
...
"             }"));
        ...
        checkBoxDelegations->setObjectName(QStringLiteral("checkBoxDelegations"));
        ...
        labelAmountSend->setText(QStringLiteral("0.00 SRG"));
        ...
        btnShieldCoins->setObjectName(QStringLiteral("btnShieldCoins"));
    ...
    void retranslateUi(QWidget *send)
    {
        ...
        labelSubtitle1->setText(QApplication::translate("send", "Transfer coins publicly or privately", Q_NULLPTR));
        groupBox->setTitle(QString());
        pushLeft->setText(QApplication::translate("send", "Transparent", Q_NULLPTR));
        pushRight->setText(QApplication::translate("send", "Shielded", Q_NULLPTR));
        labelSubtitle2->setText(QApplication::translate("send", "Select which coins to spend", Q_NULLPTR));
        labelSubtitleAddress->setText(QApplication::translate("send", "SURGE address or contact label", Q_NULLPTR));
        labelSubtitleAmount->setText(QApplication::translate("send", "Amount", Q_NULLPTR));
        checkBoxDelegations->setText(QApplication::translate("send", "Include delegated", Q_NULLPTR));
