...
"}"));
        ...
        pushCopyMemo->setObjectName(QStringLiteral("pushCopyMemo"));
        ...
        textMemo->setObjectName(QStringLiteral("textMemo"));
        ...
        labelDividerMemo->setObjectName(QStringLiteral("labelDividerMemo"));
        labelDividerMemo->setMaximumSize(QSize(16777215, 1));
        labelDividerMemo->setStyleSheet(QStringLiteral("background-color:#bababa;"));
    ...
    void retranslateUi(QWidget *TxDetailDialog)
    {
        ...
        labelMemo->setText(QApplication::translate("TxDetailDialog", "Memo", Q_NULLPTR));
