...
"SURGE Core Wallet", Q_NULLPTR));
        labelMessage2->setText(QApplication::translate("WelcomeContentWidget", "SURGE is the world\342\200\231s most innovative Proof of Stake blockchain based technology. Developed by a team of highly experienced developers and cryptographers.", Q_NULLPTR));
        labelTitle3->setText(QApplication::translate("WelcomeContentWidget", "How SURGE respects your privacy?", Q_NULLPTR));
        labelMessage3->setText(QApplication::translate("WelcomeContentWidget", "<html><head/><body><p>As our manifesto says: Privacy is a non-negotiable basic human right; it grants users the freedom to share their data whenever and with whomever they want - SURGE believes in self sovereignty.</p></body></html>", Q_NULLPTR));
        labelTitle4->setText(QApplication::translate("WelcomeContentWidget", "What is a Masternode?", Q_NULLPTR));
        labelMessage4->setText(QApplication::translate("WelcomeContentWidget", "The masternode network is SURGE's second layer network on top of the blockchain that enables our DAO to provide decentralized governance and a treasury.", Q_NULLPTR));
    } // retranslateUi
