...
#include "qt/surge/optionbutton.h"
...
"                   padding:0px;"));
    ...
    void retranslateUi(QWidget *ColdStakingWidget)
    {
        ...
        labelTitle->setText(QApplication::translate("ColdStakingWidget", "Cold Staking", Q_NULLPTR));
        labelSubtitle1->setText(QApplication::translate("ColdStakingWidget", "You can delegate your SRGs, letting a hot node (24/7 online node)\n"
"stake on your behalf, while you keep the keys securely offline.", Q_NULLPTR));
        groupBox->setTitle(QString());
        pushLeft->setText(QApplication::translate("ColdStakingWidget", "Staker", Q_NULLPTR));
        pushRight->setText(QApplication::translate("ColdStakingWidget", "Delegation", Q_NULLPTR));
        labelSubtitle2->setText(QApplication::translate("ColdStakingWidget", "Accept SRG delegation / Delegate SRG", Q_NULLPTR));
        labelEditTitle->setText(QApplication::translate("ColdStakingWidget", "Cold Staking address", Q_NULLPTR));
        ...
        lineEditOwnerAddress->setPlaceholderText(QApplication::translate("ColdStakingWidget", "Enter owner address", Q_NULLPTR));
        pushButtonClear->setText(QApplication::translate("ColdStakingWidget", "Clear All", Q_NULLPTR));
        pushButtonSend->setText(QApplication::translate("ColdStakingWidget", "Delegate", Q_NULLPTR));
        labelListHistory->setText(QApplication::translate("ColdStakingWidget", "Delegated balance history", Q_NULLPTR));
        labelStakingTotal->setText(QApplication::translate("ColdStakingWidget", "Total Staking:", Q_NULLPTR));
        pushImgEmpty->setText(QString());
        labelEmpty->setText(QApplication::translate("ColdStakingWidget", "No delegations yet", Q_NULLPTR));
    } // retranslateUi
