...
public:
    ...
    void setupUi(QWidget *TxRow)
    {
        ...
        containerAmounts->setObjectName(QStringLiteral("containerAmounts"));
        ...
        lblAmountTop->setObjectName(QStringLiteral("lblAmountTop"));
        lblAmountTop->setStyleSheet(QStringLiteral(""));

        verticalLayout_4->addWidget(lblAmountTop, 0, Qt::AlignRight);

        lblAmountBottom = new QLabel(containerAmounts);
        lblAmountBottom->setObjectName(QStringLiteral("lblAmountBottom"));
        lblAmountBottom->setStyleSheet(QStringLiteral(""));
    ...
    void retranslateUi(QWidget *TxRow)
    {
        ...
        lblAmountTop->setText(QApplication::translate("TxRow", "+0.000585 SRG", Q_NULLPTR));
        lblAmountBottom->setText(QApplication::translate("TxRow", "-0.000585 SRG", Q_NULLPTR));
