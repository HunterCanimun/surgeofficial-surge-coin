...
public:
    ...
    void retranslateUi(QDialog *MasterNodeWizardDialog)
    {
        ...
        labelMessage1a->setText(QApplication::translate("MasterNodeWizardDialog", "<html><head/><body><p>To create a SURGE Masternode you must dedicate 85,000 SRG (the unit of SURGE) to the network (however, these coins are still yours and will never leave your possession). </p><p></p><p>You can deactivate the node and unlock the coins at any time.</p></body></html>", Q_NULLPTR));
        ...
        labelMessage3->setText(QApplication::translate("MasterNodeWizardDialog", "<html><head/><body><p>A transaction of 85,000 SRG will be made</p><p>to a new empty address in your wallet.</p><p>The Address is labeled under the master node's name.</p></body></html>", Q_NULLPTR));
