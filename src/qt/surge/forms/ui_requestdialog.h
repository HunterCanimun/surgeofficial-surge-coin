...
public:
    ...
    void retranslateUi(QDialog *RequestDialog)
    {
        ...
        labelMessage->setText(QApplication::translate("RequestDialog", "Instead of sharing only a SURGE address, you can create a payment request, bundling up more information", Q_NULLPTR));
        labelSubtitleAmount->setText(QApplication::translate("RequestDialog", "Amount", Q_NULLPTR));
        comboBoxCoin->setText(QApplication::translate("RequestDialog", "SRG", Q_NULLPTR));
