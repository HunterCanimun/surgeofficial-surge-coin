...
public:
    ...
    void setupUi(QWidget *SendMultiRow)
    {
        ...
        lineEditAmount->setPlaceholderText(QStringLiteral("0.00 SRG"));
...
"padding:0px;"));
        ...
        containerMemo->setObjectName(QStringLiteral("containerMemo"));
        ...
        btnAddMemo->setObjectName(QStringLiteral("btnAddMemo"));
        btnAddMemo->setText(QStringLiteral("Add Encrypted Memo"));
