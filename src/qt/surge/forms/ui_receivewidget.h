...
public:
    ...
    void retranslateUi(QWidget *ReceiveWidget)
    {
        ...
        labelSubtitle1->setText(QApplication::translate("ReceiveWidget", "Scan the QR code or copy the address to receive SRG", Q_NULLPTR));
        groupBox->setTitle(QString());
        pushLeft->setText(QApplication::translate("ReceiveWidget", "Transparent", Q_NULLPTR));
        pushRight->setText(QApplication::translate("ReceiveWidget", "Shielded", Q_NULLPTR));
        labelSubtitle2->setText(QApplication::translate("ReceiveWidget", "Accept transparent or shielded SRG", Q_NULLPTR));
