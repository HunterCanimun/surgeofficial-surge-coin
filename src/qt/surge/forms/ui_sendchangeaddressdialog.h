...
public:
    ...
    void retranslateUi(QDialog *SendChangeAddressDialog)
    {
        ...
        labelMessage->setText(QApplication::translate("SendChangeAddressDialog", "The remainder of the value resultant from the inputs minus the outputs value goes to the \"change\" SURGE address", Q_NULLPTR));
