...
static const CAmount MN_COLL_AMT = 85000 * COIN;
...
//
// The Masternode Class. It contains the input of the 85000 SRG, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 10000 SRG - checking if valid masternode)
