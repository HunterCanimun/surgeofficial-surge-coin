...
//
// The Masternode Class. It contains the input of the 85,000 SRG, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 85,000 SRG - checking if valid masternode)
