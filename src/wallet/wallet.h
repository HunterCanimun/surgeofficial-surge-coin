...
#ifndef SURGE_WALLET_H
#define SURGE_WALLET_H
...
enum WalletFeature {
    ...
    FEATURE_PRE_SURGE = 61000, // inherited version..
...
public:
     ...
     * SURGE: group coins by pair <CTxDestination, Optional<CTxDestination>>. The optional destination
    ...
    /// Get 10000 SRG output and keys which can be used for the Masternode
