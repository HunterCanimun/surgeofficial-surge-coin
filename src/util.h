...
extern const char * const SURGE_CONF_FILENAME;
extern const char * const SURGE_PID_FILENAME;
extern const char * const SURGE_MASTERNODE_CONF_FILENAME;
...
{
    std::string s = strprintf("surge-%s", name);
